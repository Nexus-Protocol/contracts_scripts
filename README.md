...
- `npm run calc-airdrop -- -G /Users/pronvis/Yandex.Disk.localized/crypto/nexus/gov_stakers_4196500.txt -O airdrop_output -T 100000000 -C ./src/airdrop/default_psi_to_anc_ratio.json` - calculate merkle tree for airdrop and amounts for each address with proofs
